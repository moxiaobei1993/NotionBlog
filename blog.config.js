...
const BLOG = {
  ...
  AUTHOR: '莫小贝', // 作者
  BIO: '一个折腾的干饭人🍚', // 作者简介
  LINK: 'https://blog.moxiaobei.eu.org/', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'mail@moxiaobei.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/moxiaobei1993/NotionBlog', // 你的github个人主页
  ...
  POSTS_PER_PAGE: 12, // post counts per page每页文章数量
